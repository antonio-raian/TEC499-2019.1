...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/submodules/Problema1_irq_mapper.sv \
  $QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv \
  $QSYS_SIMDIR/submodules/Problema1_rsp_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/Problema1_rsp_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/Problema1_cmd_xbar_mux.sv \
  $QSYS_SIMDIR/submodules/Problema1_cmd_xbar_demux.sv \
  $QSYS_SIMDIR/submodules/altera_reset_controller.v \
  $QSYS_SIMDIR/submodules/altera_reset_synchronizer.v \
  $QSYS_SIMDIR/submodules/Problema1_id_router.sv \
  $QSYS_SIMDIR/submodules/Problema1_addr_router.sv \
  ...
  $QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_custom_instruction_master_multi_xconnect.sv \
  $QSYS_SIMDIR/submodules/altera_customins_master_translator.v \
  $QSYS_SIMDIR/submodules/Problema1_onchip_memory2_0.v \
  $QSYS_SIMDIR/submodules/Problema1_Botoes.v \
  $QSYS_SIMDIR/submodules/Problema1_LedColuna.v \
  $QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0.v \
  $QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_jtag_debug_module_sysclk.v \
  $QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_jtag_debug_module_tck.v \
  $QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_jtag_debug_module_wrapper.v \
  $QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_oci_test_bench.v \
  $QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_test_bench.v \
  $QSYS_SIMDIR/Problema1.v \
  -top $TOP_LEVEL_NAME
# ----------------------------------------
# simulate
