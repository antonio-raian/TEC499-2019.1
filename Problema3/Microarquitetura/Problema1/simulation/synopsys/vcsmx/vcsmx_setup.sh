...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Problema1_irq_mapper.sv"                                            -work irq_mapper                                                                       
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                        -work rsp_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Problema1_rsp_xbar_mux.sv"                                          -work rsp_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Problema1_rsp_xbar_demux.sv"                                        -work rsp_xbar_demux                                                                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                        -work cmd_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Problema1_cmd_xbar_mux.sv"                                          -work cmd_xbar_mux                                                                     
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Problema1_cmd_xbar_demux.sv"                                        -work cmd_xbar_demux                                                                   
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Problema1_id_router.sv"                                             -work id_router                                                                        
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Problema1_addr_router.sv"                                           -work addr_router                                                                      
  ...
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/altera_customins_slave_translator.sv"                               -work nios2_qsys_0_custom_instruction_master_multi_slave_translator0                   
  vlogan +v2k -sverilog "$QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_custom_instruction_master_multi_xconnect.sv" -work nios2_qsys_0_custom_instruction_master_multi_xconnect                            
  ...
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Problema1_onchip_memory2_0.v"                                       -work onchip_memory2_0                                                                 
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Problema1_Botoes.v"                                                 -work Botoes                                                                           
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Problema1_LedColuna.v"                                              -work LedColuna                                                                        
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0.v"                                           -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_jtag_debug_module_sysclk.v"                  -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_jtag_debug_module_tck.v"                     -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_jtag_debug_module_wrapper.v"                 -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_oci_test_bench.v"                            -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/submodules/Problema1_nios2_qsys_0_test_bench.v"                                -work nios2_qsys_0                                                                     
  vlogan +v2k           "$QSYS_SIMDIR/Problema1.v"                                                                                                                                                          
fi
